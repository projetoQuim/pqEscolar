<%-- 
    Página   : Inicio
    Página criada em : 3 de jun. de 2022, 14:24:28
    Funcionalidade :
    Autor     : Administrador
--%>
...
<html lang="pt-br">
    <head>
        ...
        <style>
            section#inicio{
                background-image: url("imagens/escola3_site.png");
            ...
            <section class="usuario">
                ...
                <nav id="navbar" class="nav-menu">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Aluno.jsp?acao=em_branco">
                                <svg width="16" height="16" fill="currentColor" class="bi bi-mortarboard" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <svg width="16" height="16" fill="currentColor" class="bi bi-incognito" viewBox="0 0 16 16">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <svg width="16" height="16" fill="currentColor" class="bi bi-server" viewBox="0 0 16 16">
